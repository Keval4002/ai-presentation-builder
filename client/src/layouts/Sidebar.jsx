...
import { ChevronFirst, ChevronLast, User2, Home, Trash2, Clock, ChevronDown, ChevronRight } from 'lucide-react';
...
function Sidebar() {
  ...
  const toggleSidebar = () => {
    ...
    // Close recently viewed when collapsing
    if (!isCollapsed) {
  ...
  const toggleRecentlyViewed = () => {
    if (!isCollapsed) {
      setIsRecentlyViewedOpen(!isRecentlyViewedOpen);
    }
  };
